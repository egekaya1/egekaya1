...
|------|----------|--------|----------|
| 2025 | **Git-Sim** | Python · Dulwich · Rich · Typer · Textual | CLI tool that simulates dangerous Git operations (rebase, merge, reset, cherry-pick) without modifying your repository. Features visual before/after commit graphs, conflict prediction, safety analysis with danger levels, educational explanations, snapshot system, and interactive TUI. Includes extensible plugin system and comprehensive test suite. Repository: https://github.com/your-org/git-sim |
